...
#
#
# engine = create_engine('postgresql+psycopg2://%s:%s@%s/%s' % (main.config['DATABASE_USER'],
#                                                               main.config['DATABASE_PASSWORD'],
#                                                               main.config['DATABASE_IP'],
#                                                               main.config['DATABASE_NAME']),
#                        encoding='utf8', echo=True, pool_recycle=300, query_cache_size=0, pool_pre_ping=True)
