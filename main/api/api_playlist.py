...
from main.utils.playlist import get_all_playlists_user_with_user_id, get_playlist_by_id
...
async def api_get_all_playlist(user: UserRegular = Depends(get_current_user)):
    get_user_all_playlist = await get_all_playlists_user_with_user_id(user.id)
